...
#define NRFX_SPIM_SCK_PIN  23
#define NRFX_SPIM_MOSI_PIN 22
#define NRFX_SPIM_MISO_PIN NRFX_SPIM_PIN_NOT_USED
#define NRFX_SPIM_SS_PIN   20
#define NRFX_SPIM_DCX_PIN  21
#define NRFX_SPIM_RESET_PIN  19
...
#define ST7789_RST_Clr() nrf_gpio_pin_clear(NRFX_SPIM_RESET_PIN)//HAL_GPIO_WritePin(ST7789_RST_PORT, ST7789_RST_PIN, GPIO_PIN_RESET)
#define ST7789_RST_Set() nrf_gpio_pin_set(NRFX_SPIM_RESET_PIN)//HAL_GPIO_WritePin(ST7789_RST_PORT, ST7789_RST_PIN, GPIO_PIN_SET)
...
//	ST7789_UnSelect();
		static uint8_t m_tx_buf_cmd;
		m_tx_buf_cmd = cmd;
		nrfx_spim_xfer_desc_t xfer_desc = NRFX_SPIM_XFER_TRX(&m_tx_buf_cmd, 1, NULL, 0);
...
{
		static uint8_t m_tx_buf[100];
		memcpy(m_tx_buf, buff, buff_size);
		nrfx_spim_xfer_desc_t xfer_desc = NRFX_SPIM_XFER_TRX(m_tx_buf, buff_size, NULL, 0);
	spi_xfer_done = false;
